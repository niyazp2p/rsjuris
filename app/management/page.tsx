...
export default function ManagementPage() {
  return (
    <main className="w-full bg-[#FAF7F0] text-[#001C41] selection:bg-[#96702A]/20 selection:text-[#001C41] antialiased overflow-x-hidden">
      {/* =========================================================================
          1. MANAGEMENT HERO SECTION (Executive Navy Canvas Preserved)
         ========================================================================= */}
      <section className="relative w-full min-h-[50svh] lg:min-h-[58svh] flex flex-col justify-center overflow-hidden bg-[#001730] text-slate-100 border-b border-[#C9A24D]/20">
        {/* Ambient Glows */}
        <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 sm:translate-x-0 sm:left-12 w-80 sm:w-[36rem] h-80 sm:h-[36rem] rounded-full bg-[#C9A24D]/10 blur-[135px]" />
          <div className="absolute inset-0 bg-gradient-to-b from-[#000E1F]/70 via-[#001730]/60 to-[#001730]" />
        </div>

        <div className="relative z-10 w-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 pt-28 sm:pt-36 pb-12 sm:pb-16 flex flex-col items-center sm:items-start text-center sm:text-left">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-[2px] border border-[#C9A24D]/40 bg-[#001730]/90 backdrop-blur-md shadow-sm mb-4"
          >
          ...
          <motion.h1
            ...
            className="font-serif text-3xl xs:text-4xl sm:text-5xl lg:text-[3.8rem] text-white font-light tracking-tight leading-[1.12]"
          >
            Firm Leadership & <br />
          ...
          <motion.p
            ...
            className="mt-3.5 sm:mt-5 text-[13.5px] sm:text-base md:text-lg text-slate-300/90 font-light leading-relaxed max-w-xl mx-auto sm:mx-0 drop-shadow-[0_1px_3px_rgba(0,23,48,0.8)]"
          >
      ...
      {/* =========================================================================
          2. ABOUT FOUNDER: LIGHT AESTHETIC (IVORY #FAF7F0 + SATIN GOLD)
         ========================================================================= */}
      <section className="relative w-full py-16 sm:py-24 lg:py-28 px-5 sm:px-8 lg:px-12 bg-[#FAF7F0] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            {/* Left: Founder Portrait Card (Light Parchment Frame) */}
            <motion.div
            ...
            {/* Right: Method & Philosophy Narrative (Approach To Work Only) */}
            <motion.div
            ...
            >
              ...
              {/* Concise Approach-Only Narrative */}
              ...
              {/* 3 Core Approach Pillars in Light Aesthetics */}
              ...
              >
                ...
                <a
                  href="mailto:devanshu@rsjuris.com"
                  className="flex-1 sm:flex-initial group inline-flex items-center justify-center gap-2 px-5 sm:px-7 py-3.5 rounded-[2px] border border-[#96702A]/40 bg-white/90 text-[#001C41] hover:bg-[#001C41] hover:text-white hover:border-[#001C41] transition-all text-[11px] sm:text-xs tracking-[0.16em] uppercase font-semibold active:scale-[0.98] shadow-sm"
                >
                  <Mail className="w-4 h-4 text-[#96702A] group-hover:text-white transition-colors" />
